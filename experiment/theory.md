...
**<span style="font-family: 'Times New Roman'; font-size: 22px;">1. Definition:</span>** <span style="font-family: 'Times New Roman'; font-size: 22px;">A non-empty subset <i>W</i> of <i>V</i> is called a subspace if it is a vector space with respect to the addition and scalar multiplication defined on <i>V</i>.</span><br>
![Definition](images/exp2newimage1.1.PNG "Definition")<br>

**<span style="font-family: 'Times New Roman'; font-size: 22px;">2. Characterization:</span>** <span style="font-family: 'Times New Roman'; font-size: 22px;">A set <i>W</i> is a subspace of <i>V</i> if and only if <br>
  i.   <i>W</i>⊆<i>V</i> <br>
  ii.  0∈<i>W</i> <br>
